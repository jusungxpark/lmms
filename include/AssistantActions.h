...
public:
    ...
    // === CREATIVE OPERATIONS ===
    ActionResult generateDrumPattern(const QJsonObject& params); // {style: house|trap|dnb|jazz, bars: number}
    ActionResult generateBassline(const QJsonObject& params);    // {style: walking|808|reese|sub, key: string, bars: number}
